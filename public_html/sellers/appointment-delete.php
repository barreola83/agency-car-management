      ...
      <div class="app-body">
        ...
        <div class="app-content">
          ...
          <div class="container-fluid">
            <h2 style="text-align:center">Eliminar cita</h2>

            <div class="row">
              <div class="col col-md-12 col-lg-12">
                <div class="form-group">
                  <label>
                    Introduzca el ID de la cita <small class="text-secondary">(requerido)</small>
                  </label>
              ...
              <div class="col col-md-3 col-lg-3">
                <div class="form-group">
                  <button class="btn btn-block btn-success">Eliminar</button>
                </div>
              </div>
            </div>
          </div>
