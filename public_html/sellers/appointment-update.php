      ...
      <div class="app-body">
        ...
        <div class="app-content">
          ...
          <div class="container-fluid">
            <h2 style="text-align:center">Actualización de Citas</h2>

            <div class="row">
              <div class="col col-md-12 col-lg-12">
                <div class="form-group">
                  <label>
                    Introduzca el ID de la cita <small class="text-secondary">(obligatorio)</small>
                  </label>
              ...
              <div class="form-group">
             <label>
                 Seleccione la nueva fecha deseada <small class ="text-secondary">(obligatorio)</small>
              </label>
